...
const AlertDialog = ({ ...props }: AlertDialogPrimitive.Root.Props): React.JSX.Element => {
...
const AlertDialogPortal = ({ ...props }: AlertDialogPrimitive.Portal.Props): React.JSX.Element => {
